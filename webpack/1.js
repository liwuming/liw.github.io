...
function create_detail(dirname,filepath){
	...
	if(result && result.length>0){
		...
		*/commands[dirname][obj.command] = {
		...
		contents = '<div class="ui-body-section"><div class="ui-main-section"><div class="ui-article-section"> <div class="ui-article-title"> <h1>'+obj.command+'</h1><div class="operate"> <a target="_blank" href="https://github.com/jaywcjlove/linux-command/edit/master/command/apachectl.md">纠正错误</a><span class="split"></span> <a target="_blank" href="https://github.com/jaywcjlove/linux-command/edit/master/command/apachectl.md">添加实例</a> </div> </div><article id="detail">'+contents+'</article></div><div class="ui-comments-section">评论区</div></div> <div class="ui-sidebar-section"></div></div>';
